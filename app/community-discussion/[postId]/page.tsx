...
import { ChevronLeft, MessageSquare, Send, UserCircle2, Loader2, CheckCircle, ArrowLeftCircle, ArrowRightCircle, Star, ChevronRight } from 'lucide-react'; // Added ChevronRight
...
export default function DiscussionPostPage() {
    ...
    const handleCommentSubmit = async (e: React.FormEvent) => {
        ...
        const commentToAdd: DiscussionComment = {
            ...
            createdAt: Timestamp.now(), // Changed from serverTimestamp()
        };
        ...
        try {
            ...
            // Update UI optimistically with the commentToAdd object directly
            setPost(prevPost => prevPost ? { ...prevPost, comments: [...(prevPost.comments || []), commentToAdd] } : null);
    ...
    const formatRelativeTime = (timestamp: Timestamp | null | undefined) => {
        ...
        try {
            ...
            // Fallback for cases where timestamp might not be a Firestore Timestamp object (e.g. from mock data or older data)
            const date = new Date(timestamp as any); // Attempt to parse
            ...
            <div className="space-y-6 mb-8">
                {post.comments && post.comments.length > 0 ? (
                    post.comments.sort((a, b) => {
                        const aDate = a.createdAt instanceof Timestamp ? a.createdAt.toDate() : new Date(a.createdAt as any);
                        const bDate = b.createdAt instanceof Timestamp ? b.createdAt.toDate() : new Date(b.createdAt as any);
